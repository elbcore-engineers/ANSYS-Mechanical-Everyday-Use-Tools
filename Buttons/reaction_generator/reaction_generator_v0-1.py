...
class ReactionForm(Form):
    def __init__(self):
        ...
        self.checkBoxRename.Text = "Vorhandene Reaktionen überschreiben?"
        ...
        self.checkBoxGroup.Text = "Generierte Reaktionen gruppieren?"
